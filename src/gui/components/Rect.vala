namespace Planly
{
    ...
    public class Rect : Shape
    {
        ...
        private double left()   { return double.min(origin_x, corner_x); }
        private double top()    { return double.min(origin_y, corner_y); }
        private double right()  { return double.max(origin_x, corner_x); }
        private double bottom() { return double.max(origin_y, corner_y); }
        ...
        public override void paint(Cairo.Context cr)
        {
            ...
            if (_is_selected) {
                ...
                paint_handle(cr, left(),  top());
                paint_handle(cr, right(), top());
                paint_handle(cr, left(),  bottom());
                paint_handle(cr, right(), bottom());
            }
